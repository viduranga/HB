...
import model.feedforward.train.Train;
...
public class Backpropagation implements Train {
	 ...
	 * @param ideal
	 * @param learnRate
	 *            The rate at which the weight model.matrix will be adjusted based on
	 *            learning.
	 * @param momentum
	...
	/**
	 * Modify the weight model.matrix and thresholds based on the last call to
	 * calcError.
	 */
	public void learn() {
