...
package model.feedforward.train.backpropagation;

import model.feedforward.FeedforwardLayer;
...
public class BackpropagationLayer {
	...
	/**
	 * Accumulate the error deltas for each weight model.matrix and bias value.
	 */
	...
	/**
	 * Hold the previous model.matrix deltas so that "momentum" can be implemented.
	...
	/**
	 * Accumulate a model.matrix delta.
	 * @param i1 The model.matrix row.
	 * @param i2 The model.matrix column.
