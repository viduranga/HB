...
public class NormalizeInput {
	...
	/**
	 * The input expressed as a model.matrix.
	 */
	protected Matrix inputMatrix;

	/**
	 * Normalize an input array into a model.matrix. The resulting model.matrix will have
	...
	/**
	 * Create an input model.matrix that has enough space to hold the extra synthetic
	 * input.
	 * 
	 * @param pattern
	 ...
	 * @param extra
	 *            The synthetic input.
	 * @return A model.matrix that contains the input pattern and the synthetic input.
	 */
	...
	/**
	 * Get the resulting input model.matrix.
	 * @return The resulting input model.matrix.
	 */
