...
public class TrainSelfOrganizingMap {
	...
	/**
	 * The work model.matrix, used to calculate corrections.
	 */
	private Matrix work;
	
	/**
	 * The correction model.matrix, will be applied to the weight model.matrix after each
	 * training iteration.
	 */
	...
	/**
	 * Copy the weights from one model.matrix to another.
	...
	/**
	 * Normalize the specified row in the weight model.matrix.
	 * @param matrix The weight model.matrix.
